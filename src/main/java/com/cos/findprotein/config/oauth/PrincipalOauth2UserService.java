package com.cos.findprotein.config.oauth;
...
import com.cos.findprotein.config.oauth.provider.FacebookUserInfo;
import com.cos.findprotein.config.oauth.provider.GoogleUserInfo;
